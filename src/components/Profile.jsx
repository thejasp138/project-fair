...
function Profile() {
  ...
  useEffect(()=>{
    if(user.profile){
      setPreview(URL.createObjectUR(user.profile))
    }
    else{
      setPreview("")
    }
      ...
      <div className='p-5 border shadow border-3 mm-3'>
        ...
        <div>
                 <label >
                    ...
                    {
                      existingProfile==" " ?
                      <img className='img-fluid' style={{width:'200px'}} src={preview?preview:"https://st3.depositphotos.com/15648834/17930/v/450/depositphotos_179308454-stock-illustration-unknown-person-silhouette-glasses-profile.jpg"} alt="" />

                      :
                      <img className='img-fluid' style={{width:'200px'}} src={preview?preview:`${server_url}/uploads/${existingProfile}`} alt="" />
